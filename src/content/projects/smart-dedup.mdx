...
SmartDedup is a machine learning–powered system designed to identify and merge duplicate patient records across distributed SQL Server databases.  
...
This project combines **ML modeling**, **data engineering**, **API design**, and **performance optimization** using modern tools such as **dedupe**, **DuckDB**, **Polars**, and **FastAPI**, while integrating with external partner systems.
...
- Unique identifiers can be inconsistent  
...
FastAPI backend
↓
REST API → external partner systems
↓
...
- Uses dedupe’s field-based similarity algorithms  
...
External partners can consume these results directly.
...
## ⚙️ Multi-Server Synchronization
...
SmartDedup is more than a simple deduplication tool — it is a **full data quality and machine learning pipeline**, designed for real-world healthcare environments.
...
- Deep learning–based similarity embeddings  
